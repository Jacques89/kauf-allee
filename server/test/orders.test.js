      ...
      order.save((err, order) => {
        ...
        chai
          ...
          .end((err, res) => {
            ...
            expect(res.body).to.have.property('orderItems').eql(order.orderItems)
            expect(res.body).to.have.property('shippingAddress1').eql(order.shippingAddress1)
            expect(res.body).to.have.property('shippingAddress2').eql(order.shippingAddress2)
            expect(res.body).to.have.property('city').eql(order.city)
            expect(res.body).to.have.property('postcode').eql(order.postcode)
            expect(res.body).to.have.property('country').eql(order.country)
            expect(res.body).to.have.property('phone').eql(order.phone)
